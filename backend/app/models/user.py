...
class User(Base, UUIDMixin, TenantScopedMixin, AuditMixin):
    ...
    accessible_entities = relationship("Entity", secondary="entity_access", back_populates="users_with_access")

    # Tasks assigned to this user
    assigned_tasks = relationship("WorkflowTask", foreign_keys="[WorkflowTask.assigned_to_user_id]", back_populates="assigned_user")
