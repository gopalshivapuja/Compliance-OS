...
class TenantBase(BaseModel):
    ...
    tenant_name: str = Field(..., min_length=2, max_length=255, description="Tenant organization name")
...
class TenantCreate(TenantBase):
    ...
    meta_data: Optional[Dict[str, Any]] = Field(None, description="Tenant-specific metadata (JSONB)")
...
class TenantResponse(TenantBase):
    ...
    id: Union[str, UUID] = Field(..., description="Tenant UUID")
    ...
    created_by: Optional[Union[str, UUID]] = Field(None, description="Creator user ID")
    updated_by: Optional[Union[str, UUID]] = Field(None, description="Last updater user ID")
