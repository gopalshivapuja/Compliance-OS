...
def upgrade() -> None:
    ...
    op.create_table('compliance_masters',
    ...
    op.create_index('idx_compliance_masters_tenant_code', 'compliance_masters', ['tenant_id', 'compliance_code'], unique=True)
    op.create_index(op.f('ix_compliance_masters_category'), 'compliance_masters', ['category'], unique=False)
    op.create_index(op.f('ix_compliance_masters_compliance_code'), 'compliance_masters', ['compliance_code'], unique=False)
    op.create_index(op.f('ix_compliance_masters_compliance_name'), 'compliance_masters', ['compliance_name'], unique=False)
    op.create_index(op.f('ix_compliance_masters_frequency'), 'compliance_masters', ['frequency'], unique=False)
    op.create_index(op.f('ix_compliance_masters_is_active'), 'compliance_masters', ['is_active'], unique=False)
    op.create_index(op.f('ix_compliance_masters_tenant_id'), 'compliance_masters', ['tenant_id'], unique=False)
    ...
    op.create_table('compliance_instances',
    sa.Column('tenant_id', sa.UUID(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['blocking_compliance_instance_id'], ['compliance_instances.id'], ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['compliance_master_id'], ['compliance_masters.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['entity_id'], ['entities.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['owner_user_id'], ['users.id'], ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['tenant_id'], ['tenants.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index('idx_compliance_instances_entity_status', 'compliance_instances', ['entity_id', 'status', 'due_date'], unique=False)
    op.create_index('idx_compliance_instances_tenant_status_due', 'compliance_instances', ['tenant_id', 'status', 'rag_status', 'due_date'], unique=False)
    op.create_index('idx_compliance_instances_unique', 'compliance_instances', ['compliance_master_id', 'entity_id', 'period_start', 'period_end'], unique=True)
    op.create_index(op.f('ix_compliance_instances_compliance_master_id'), 'compliance_instances', ['compliance_master_id'], unique=False)
    op.create_index(op.f('ix_compliance_instances_due_date'), 'compliance_instances', ['due_date'], unique=False)
    op.create_index(op.f('ix_compliance_instances_entity_id'), 'compliance_instances', ['entity_id'], unique=False)
    op.create_index(op.f('ix_compliance_instances_owner_user_id'), 'compliance_instances', ['owner_user_id'], unique=False)
    op.create_index(op.f('ix_compliance_instances_period_end'), 'compliance_instances', ['period_end'], unique=False)
    op.create_index(op.f('ix_compliance_instances_period_start'), 'compliance_instances', ['period_start'], unique=False)
    op.create_index(op.f('ix_compliance_instances_rag_status'), 'compliance_instances', ['rag_status'], unique=False)
    op.create_index(op.f('ix_compliance_instances_status'), 'compliance_instances', ['status'], unique=False)
    op.create_index(op.f('ix_compliance_instances_tenant_id'), 'compliance_instances', ['tenant_id'], unique=False)
    op.create_table('entity_access',
    ...
    op.create_index(op.f('ix_entity_access_tenant_id'), 'entity_access', ['tenant_id'], unique=False)
    ...
    sa.ForeignKeyConstraint(['compliance_instance_id'], ['compliance_instances.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['parent_evidence_id'], ['evidence.id'], ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['tenant_id'], ['tenants.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index('idx_evidence_compliance_status', 'evidence', ['compliance_instance_id', 'approval_status'], unique=False)
    op.create_index('idx_evidence_hash', 'evidence', ['file_hash'], unique=False)
    op.create_index(op.f('ix_evidence_approval_status'), 'evidence', ['approval_status'], unique=False)
    op.create_index(op.f('ix_evidence_compliance_instance_id'), 'evidence', ['compliance_instance_id'], unique=False)
    ...
    op.create_index('idx_workflow_tasks_assigned_user_status', 'workflow_tasks', ['assigned_to_user_id', 'status', 'due_date'], unique=False)
    op.create_index('idx_workflow_tasks_instance_sequence', 'workflow_tasks', ['compliance_instance_id', 'sequence_order'], unique=False)
    op.create_index(op.f('ix_workflow_tasks_assigned_to_user_id'), 'workflow_tasks', ['assigned_to_user_id'], unique=False)
    op.create_index(op.f('ix_workflow_tasks_compliance_instance_id'), 'workflow_tasks', ['compliance_instance_id'], unique=False)
    op.create_index(op.f('ix_workflow_tasks_due_date'), 'workflow_tasks', ['due_date'], unique=False)
    ...
    op.create_table('evidence_tag_mappings',
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_compliance_instances_compliance_master_id'), table_name='compliance_instances')
